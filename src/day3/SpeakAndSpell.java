...
static	String word = "marvelous";
	...
	public static void main(String[] args) {
		...
		String word = JOptionPane.showInputDialog("Spell this word: (Use lowercase)");
		

		// 2. Catch the user's answer in a String
		if(word.equals("marvelous")) {
			JOptionPane.showMessageDialog(null,"Correct!, you are awesome!");
		}

		// 3. If the user spelled the word correctly, speak "correct"
		else { JOptionPane.showMessageDialog(null, word + " is incorrect. Try again.");
